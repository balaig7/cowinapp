...
function showHospitals(district_id, date) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (blocks.length > 2) {
                hospitals += '<div class="d-flex blocks">'
                hospitals += '<div class="col">'
            ...
            $.each(data.sessions, function(index, value) {
                ...
                hospitals += '<div class="card border-0 " onclick="viewDetails();">'
                ...
                $.each(value.slots, function(ind, availableslots) {
                    hospitals += '<p class="rounded border slots border-primary text-center">' + availableslots + '</p>'
                })
